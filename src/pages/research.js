      ...
      <section id="main" className="wrapper">
        <div className="inner">
          ...
          <p>
            ...
            identification across multiple networks. The project also involves
            setting up a custom test environment, deploying contracts between
            independent testnets, and implementing cryptographic sortition and
            verification methods for secure messaging across networks. Future
            steps for future teams include expanding the hierarchical consensus
            model to support more complex network structures and ensuring secure
            and reliable communication between levels. <br /> <br />
            <div
              style={{
                position: 'relative',
                display: 'flex',
